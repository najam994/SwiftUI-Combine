...
class MockExcersieListService: ExcersieListServiceProtocol {
    ...
    func getExcersieList() -> Future<ExerciseInfo, Error> {
        ...
        return Future { [weak self] promise in
            ...
            if self.shouldReturnData {
                let itemObject = try! JSONDecoder().decode(ExerciseInfo.self, from: self.data)
